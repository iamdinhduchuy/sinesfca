...
export default async function SinesFCALogin(cookies: string): Promise<any>;
export default async function SinesFCALogin(username: string, password: string, twoFA?: string): Promise<any>;
...
export default async function SinesFCALogin(
  ...
  if (typeof arg2 === 'undefined') {
    ...
    // await FacebookUtils.checkHealthAccount(client.userID, client.token.EAAG || client.token.EAAB)
